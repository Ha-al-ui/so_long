...
void	init_img(t_game *game)
{
	game->img_wall = mlx_xpm_file_to_image(game->mlx,
			"./textures/wall.xpm", &game->img_wid, &game->img_hei);
	game->img_player = mlx_xpm_file_to_image(game->mlx, 
			"./textures/player.xpm", &game->img_wid, &game->img_hei);
	game->img_collect = mlx_xpm_file_to_image(game->mlx, 
			"./textures/collect.xpm", &game->img_wid, &game->img_hei);
	game->img_exit = mlx_xpm_file_to_image(game->mlx, 
			"./textures/exit_1.xpm", &game->img_wid, &game->img_hei);
	game->img_floor = mlx_xpm_file_to_image(game->mlx, 
			"./textures/floor.xpm", &game->img_wid, &game->img_hei);
